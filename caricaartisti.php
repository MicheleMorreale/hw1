...
$query="Select id_artist from liked_artists where user_id ='".$user_id."'";
 ...
 while($row = mysqli_fetch_assoc($res) and $i<3){
     
    
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL,            "https://api.spotify.com/v1/artists/"."$row[id_artist]");
